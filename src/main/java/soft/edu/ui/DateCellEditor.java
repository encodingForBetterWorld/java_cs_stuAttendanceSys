...
//
    ...
    public DateCellEditor(final DateChooser dateChooser) {
        editorComponent = dateChooser;
        this.clickCountToStart = 2;
        delegate = new EditorDelegate() {
//            public void setValue(Object value) {
//            	dateChooser.dateChooser((value != null) ? value.toString() : "");
//            }

            public Object getCellEditorValue() {
                return dateChooser.getDateText();
            }
        };
     ...
     */
//    public DateCellEditor(final JCheckBox checkBox) {
